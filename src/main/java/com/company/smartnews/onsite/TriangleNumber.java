 ...
 *
 * <p>Share Given an array consists of non-negative integers, your task is to count the number of
 ...
 *
 * <p>2,3,4 (using the first 2)
 *
 * <p>2,3,4 (using the second 2)
 *
 * <p>2,2,3
 */
...
//    System.out.println(results.toString());
  ...
  private void collect(Set<List<Integer>> results, int[] nums, int a, int b, int c) {
    for (int i = a; i < b; i++) {
