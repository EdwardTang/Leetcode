package com.company.snapchat.phone;
...
// 1. Postorder is the reverse order of pre-order with traversing right substree before traversing left substree:
//     pre-order :                             root         -> left-subtree  -> right-subtree
//     pre-order-visit-right-first:            root         -> right-subtree -> left-subtree
//     resersed-(pre-order-visit-right-first): left-subtree -> right-subtree -> root
